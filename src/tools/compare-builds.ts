    ...
    return {
      content: [{
        ...
        text: JSON.stringify({
          ...
          buildTimeDeltaText:
            comparison.buildTimeDeltaMs === null ? null : formatMs(Math.abs(comparison.buildTimeDeltaMs)),
          buildTimeDeltaDirection:
            comparison.buildTimeDeltaMs === null ? null : comparison.buildTimeDeltaMs >= 0 ? 'slower' : 'faster',
